    ...
    return (
      ...
      `}>
                <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-dark-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-dark-500">Espace Analyste</p>
                        </div>
                    </div>
                    <button
                        onClick={() => setSidebarOpen(false)}
                ...
                <div className="p-4 border-b border-gray-200 dark:border-dark-800">
                    <div className="p-3 rounded-xl bg-gradient-to-r from-secondary-500/10 to-purple-500/10 border border-secondary-200 dark:border-secondary-800">
                        <div className="flex items-center gap-2">
                            <Brain className="w-5 h-5 text-secondary-500" />
                            <span className="text-sm font-medium text-secondary-700 dark:text-secondary-300">IA Prédictive</span>
                            <span className="ml-auto px-2 py-0.5 text-xs bg-success-100 text-success-700 dark:bg-success-900/30 dark:text-success-400 rounded-full">
                                Active
                            </span>
                        </div>
                        <p className="mt-2 text-xs text-dark-500">
                            Modèle ML prêt pour les prédictions
                        </p>
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-gray-200 dark:border-dark-800">
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-dark-50 dark:bg-dark-800">
                        <Avatar name={user?.name || 'Analyste'} size="md" />
            ...
            <div className="lg:pl-72">
                <header className="sticky top-0 z-30 h-16 bg-white/80 dark:bg-dark-900/80 backdrop-blur-lg border-b border-gray-200 dark:border-dark-800">
                    <div className="flex items-center justify-between h-full px-4 lg:px-8">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                onClick={() => navigate('/analyst/reports/new')}
                                className="hidden sm:flex items-center gap-2 px-4 py-2 bg-secondary-500 hover:bg-secondary-600 text-white rounded-xl font-medium transition-colors"
                            >
                                ...
                                <AnimatePresence>
                                    {userMenuOpen && (
                                        ...
                                        >
                                            ...
                                            <button
                                                onClick={() => { navigate('/analyst/profile'); setUserMenuOpen(false) }}
